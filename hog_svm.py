...
# test_feat_path = 'test/'
# model_path = 'model/'
train_feat_path = r'D:\py exc\HOG_SVM-master\train'
test_feat_path = r'D:\py exc\HOG_SVM-master\test'
model_path = r'D:\py exc\HOG_SVM-master\model'
